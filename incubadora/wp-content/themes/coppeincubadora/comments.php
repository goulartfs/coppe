...
<?php if (have_comments()) : ?>
    ...
    <ul class="commentlist">
        <?php wp_list_comments('type=comment&callback=coppe_comment');; ?>
    </ul>
...
<!--                <p><small>--><?php //printf(__('<strong>XHTML:</strong> You can use these tags: <code>%s</code>'), allowed_tags()); ?><!--</small></p>-->
                ...
                <p>
                    ...
                    <textarea class="input-xxlarge" name="comment" id="comment" cols="58" rows="10"
                             tabindex="4"></textarea>
                </p>

                <p><input name="submit" type="submit" id="submit" class="btn btn-primary" tabindex="5"

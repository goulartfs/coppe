        ...
        <div class="row">
            <div class="span12 content-area">
                <div class="wrapper">
                    ...
                    <?php
                    $args = array('post_type' => 'biblioteca', 'posts_per_page' => 10);
                    $loop = new WP_Query($args);
                    ?>
                    <?php if ($loop->have_posts()) : ?>

                        <?php /* The loop */ ?>
                        <div class="biblioteca-acordion">
                            <?php while ($loop->have_posts()) : $loop->the_post(); ?>
                                <?php $terms = get_the_terms($post->id, 'tipo_artigo'); ?>
                                ...
                                <div class="row biblioteca-content">
                                    ...
                                    <div class="span10">
                                        ...
                                        <div class="row pos-info">
                                            ...
                                            <div class="span7 text-right data-post">
                                                <?php the_date('d/m/Y') ?>
                                            </div>
                                        </div>
                                        <?php
                                        ...
                                        <div class="edital-content">
                                            ...
                                            <?php if (get_field('link')) { ?>
                                                <div class="link-externo">
                                                    Acesse: <a href="<?php the_field('link') ?>" target="_blank"><?php the_field('link') ?></a>
                                                </div>
                                                <div id="link-mais-<?php the_ID() ?>">
                                                </div>
                                            <?php } ?>
                                        </div>
                                        <?php
    ...
    <script>
        jQuery(function () {
            jQuery('a.more-link').each(function(){
                clonado = jQuery(this).clone();
                jQuery(this).remove();
                clonado.appendTo("#link-mais-" + clonado.find('span').data('target'));
            })

                        ...
                        <header id="masthead" class="site-header" role="banner">
                                ...
                                <div id="navbar" class="navbar">
                                        <nav id="site-navigation" class="navigation main-navigation" role="navigation">
                                                <h3 class="menu-toggle"><?php _e('Menu', 'coppeincubadora'); ?></h3>
                                                <a class="screen-reader-text skip-link" href="#content" title="<?php esc_attr_e('Skip to content', 'coppeincubadora'); ?>"><?php _e('Skip to content', 'coppeincubadora'); ?></a>
        <?php get_search_form(); ?>
                                        </nav> #site-navigation 
                                </div> #navbar 
                        </header> #masthead 
                    ...
                    <div class="row">
                        <div class="span6">
                            <a href='<?php echo esc_url(home_url('/')); ?>' title="Home">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt="Incubadora de Empresas"/>
                            </a>
                        </div>

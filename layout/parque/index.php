        ...
        <div id="header">
                    ...
                    <div class="row">
                        <div class="span5 offset11 header-top-links">
                            <a href="#" title="Acesso à informação">
                                <img src="./images/acesso-informacao.jpg" alt="Acesso à informação" />
                            </a>
                            <a href="#" title="Brasil">
            ...
            <div class="header-middle">
                <div class="container">
                    <div class="row">
                        <div class="span6">
                            <img src="./images/logo.jpg" alt="Parque Tecnológico UFRJ"/>
                        </div>
                            ...
                            <div class="row">
                                <div class="span10">
                                    <ul class="bottom-links inline">
                                        ...
                                        <li><a href='#' title="Área restrita">Área restrita</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="span4 text-right">
                                <img src="images/links-sociais.jpg" alt="Redes Sociais"/>
                            </div>
                        </div>
                    </div>
                </div>

...
//                            var_dump($user);
                            ...
                            <div class="usquare_block">
                                <img src="<?php echo $upload_dir['baseurl'] . $user->profileimage; ?>" class="usquare_square" alt="" width="140" height="140"/>
                                <div class="usquare_square usquare_square_bg1">
                                    <div class="usquare_square_text_wrapper">
                                        ...
                                        <ul class="social_background inline">
                                            ...
                                            <?php if($user->google): ?><li><a href="<?php print $user->google ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/bt-email.jpg" alt="social" /></a></li><?php endif; ?>
                                            <?php if($user->twitter): ?><li><a href="<?php print $user->twitter ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/bt-email.jpg" alt="social" /></a></li><?php endif; ?>
                                            <?php if($user->linkedin): ?><li><a href="<?php print $user->linkedin ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/bt-email.jpg" alt="social" /></a></li><?php endif; ?>
                                        </ul>
                                        <div class="clear"></div>
                                    </div><!-- usquare_square_wrapper -->
                                </div><!--div    usquare_square -->
                                <div class="usquare_block_extended usquare_square_bg1">
                                    <a href="#" class="close"><img src="<?php echo get_template_directory_uri(); ?>/images/close.jpg" alt="close"/></a>
                                    <div class="clear"></div>

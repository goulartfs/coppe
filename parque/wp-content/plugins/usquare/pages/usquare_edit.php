									...
									<tr class="field-row">
										...
										<td>
											<div class="tsort-image">
												...
												<input id="<?php echo $key; ?>-item-image-input" name="<?php echo $key; ?>-item-image" type="hidden" value="<?php if (isset($arr['item-image-original'])) echo $arr['item-image-original']; ?>" />
								...
								<table class="fields-group" id="item-right-table-<?php echo $num;?>">
									...
									<tr class="field-row">
										...
										<td style="width: auto;">
											...
											<input id="<?php echo $key; ?>-item-background-image-input" name="<?php echo $key; ?>-item-background-image" type="hidden" value="<?php if (isset($arr['item-background-image-original'])) echo $arr['item-background-image-original']; ?>" />

...
<br /><label for="usquare_use_lightbox_checkbox"><input type="checkbox" name="usquare_use_lightbox_checkbox" id="usquare_use_lightbox_checkbox" value="1" '.$use_lightbox_checked.' /> Enable Lightbox</label><br /><br /><label for="usquare_skip_head_section_checkbox"><input type="checkbox" name="usquare_skip_head_section_checkbox" id="usquare_skip_head_section_checkbox" value="1" '.$skip_head_section_checked.' /> Put CSS &amp; JS near HTML block, not in &lt;head&gt; section (this can help if your template or some other plugin screws up &lt;head&gt; section)</label><br />';

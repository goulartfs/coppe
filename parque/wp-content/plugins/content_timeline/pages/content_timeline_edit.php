					...
					<li id="<?php echo $key; ?>" class="sortableItem">
						...
						<div class="tsort-content">
							...
							<div class="tsort-item">
								...
								<tr>
									<td style="width:120px;"><span class="timeline-help">? <span class="timeline-tooltip">Link to post or some other page. Leave it empty for default behaivor.</span></span><label for="<?php echo $key; ?>-item-prettyPhoto">Button URL</label></td>
